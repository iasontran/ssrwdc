...
void initLCDPins(){
  DDRB |= (1 << DDB4); // enable
  DDRB |= (1 << DDB6);  // RS
  //RA0,RA1,RA2,RA3 connected to DB4,DB5,DB6,DB7
...
if(x == 1){
  eightBitCommandWithDelay(0b11000000, 60);
}//second line
  for(int j = 0; j < y; j++){
    //eightBitCommandWithDelay(0b00000110, 60);
    // Entry mode 0 0 0 0 0 1 I/D S
    eightBitCommandWithDelay(0b00010100, 60);
    //cursor display shift 0 0 0 1 S/C R/L * *
  }

eightBitCommandWithDelay(0b00001111, 60);
...
void initLCDProcedure(){
  ...
  fourBitCommandWithDelay(0b0011,4120);
  // Write 0b0011 to DB[7:4] and delay 100 microseconds
  fourBitCommandWithDelay(0b0011,120);
  ...
  fourBitCommandWithDelay(0b0010, 40);

  // Function set in the command table
  eightBitCommandWithDelay(0b00101100, 40);
  //0 0 1 DL N$ RE * #

  // Display off in the command table
  eightBitCommandWithDelay(0b00001000, 40);
  //0 0 0 0 1 D C B
